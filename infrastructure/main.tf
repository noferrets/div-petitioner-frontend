...
data "vault_generic_secret" "idam_secret" {
  path = "secret/${var.vault_section}/ccidam/idam-api/oauth2/draftStoreClient-secrets/divorce"
}
...
locals {
  ...
  case_progression_service_url = "http://pr-43-div-cps-preview.service.core-compute-preview.internal"
